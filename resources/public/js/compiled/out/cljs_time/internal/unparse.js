...
var periods__$1 = cljs.core.vec.call(null,(function (){var G__26773 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.call(null,((function (G__26773){
return (function (p1__26772_SHARP_){
return cljs.core.subs.call(null,p1__26772_SHARP_,(0),(3));
});})(G__26773))
,G__26773);
} else {
return G__26773;
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__26782){
var vec__26783 = p__26782;
var t = cljs.core.nth.call(null,vec__26783,(0),null);
var pattern = cljs.core.nth.call(null,vec__26783,(1),null);
if(cljs.core._EQ_.call(null,t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__26786 = pattern;
switch (G__26786) {
case "S":
...
switch (G__26796__$1) {
case "millis":
return ((function (G__26796,G__26796__$1){
return (function (p1__26788_SHARP_){
return p1__26788_SHARP_.getMilliseconds();
});
;})(G__26796,G__26796__$1))

break;
case "seconds":
return ((function (G__26796,G__26796__$1){
return (function (p1__26789_SHARP_){
return p1__26789_SHARP_.getSeconds();
});
;})(G__26796,G__26796__$1))
...
return p1__26790_SHARP_.getMinutes();
});
;})(G__26796,G__26796__$1))
...
case "hours":
return ((function (G__26796,G__26796__$1){
return (function (p1__26791_SHARP_){
return p1__26791_SHARP_.getHours();
});
;})(G__26796,G__26796__$1))
...
return p1__26792_SHARP_.getHours();
});
;})(G__26796,G__26796__$1))
...
return p1__26793_SHARP_.getDate();
});
;})(G__26796,G__26796__$1))
...
return p1__26794_SHARP_.getMonth();
});
;})(G__26796,G__26796__$1))
...
return p1__26795_SHARP_.getYear();
});
;})(G__26796,G__26796__$1))
...
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__26798){
...
var key = first__26801;
var args = seq__26800__$1;
var G__26802 = key;
...
break;
case "ordinal-suffix":
var vec__26803 = syntax_list.call(null,(i - (1)));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26802__$1)].join('')));
...
var d = value;
var G__26810 = cljs.core.map_indexed.call(null,cljs.core.partial.call(null,cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__26811 = G__26810;
var seq__26812 = cljs.core.seq.call(null,vec__26811);
var first__26813 = cljs.core.first.call(null,seq__26812);
var seq__26812__$1 = cljs.core.next.call(null,seq__26812);
var unparser = first__26813;
var more = seq__26812__$1;
var s = "";
var d__$1 = d;
...
var unparser__$1 = first__26816;
var more__$1 = seq__26815__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__26817 = unparser__$1.call(null,s__$2,d__$2);
var s__$3 = cljs.core.nth.call(null,vec__26817,(0),null);
var d__$3 = cljs.core.nth.call(null,vec__26817,(1),null);
var G__26820 = d__$3;
var G__26821 = more__$1;
var G__26822 = s__$3;
d__$1 = G__26820;
G__26810__$1 = G__26821;
s__$1 = G__26822;
continue;
}
break;
...
//# sourceMappingURL=unparse.js.map?rel=1535633078569
