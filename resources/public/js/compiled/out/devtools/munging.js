...
var o28542 = temp__4655__auto__;
var temp__4655__auto____$1 = (o28542["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o28543 = temp__4655__auto____$1;
return (o28543["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27686__auto__ = f;
return (o__27686__auto__["toString"]).call(o__27686__auto__);
} else {
return "";
}
}catch (e28544){var _ = e28544;
return "";
}});
...
try{var o__27686__auto___28546 = t;
(o__27686__auto___28546["cljs$lang$ctorPrWriter"]).call(o__27686__auto___28546,t,writer);
}catch (e28545){var __28547 = e28545;
}
...
var char_code = (function (){var o__27686__auto__ = (new String(char$));
return (o__27686__auto__["charCodeAt"]).call(o__27686__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27686__auto__ = String;
return (o__27686__auto__["fromCharCode"]).call(o__27686__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28548 = num_code;
switch (G__28548) {
case (1):
return (185);
...
var o__27686__auto__ = String;
return (o__27686__auto__["fromCharCode"]).call(o__27686__auto__,superscript_code);
});
/**
...
}catch (e28550){var _e__27693__auto__ = e28550;
return false;
}})())){
...
var vec__28551 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__28551,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o28554 = temp__4655__auto__;
var temp__4655__auto____$1 = (o28554["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o28555 = temp__4655__auto____$1;
return (o28555["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___28562 = arguments.length;
var i__4500__auto___28563 = (0);
while(true){
if((i__4500__auto___28563 < len__4499__auto___28562)){
args__4502__auto__.push((arguments[i__4500__auto___28563]));

var G__28564 = (i__4500__auto___28563 + (1));
i__4500__auto___28563 = G__28564;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28558){
var vec__28559 = p__28558;
var ns_detector = cljs.core.nth.call(null,vec__28559,(0),null);
...
var G__28565 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__28566 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__28565;
remaining_tokens = G__28566;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28556){
var G__28557 = cljs.core.first.call(null,seq28556);
var seq28556__$1 = cljs.core.next.call(null,seq28556);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28557,seq28556__$1);
});
...
var vec__28570 = cljs.core.split_with.call(null,(function (p1__28569_SHARP_){
return cljs.core.not_EQ_.call(null,p1__28569_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__28570,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__28570,(1),null);
...
var vec__28573 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__28573,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__28573,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__28576 = cljs.core.rest.call(null,remaining_tokens);
var G__28577 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__28576;
name_tokens = G__28577;
continue;
} else {
...
var vec__28580 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__28580,(0),null);
var arity = cljs.core.nth.call(null,vec__28580,(1),null);
var vec__28583 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__28583,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__28583,(1),null);
var vec__28586 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__28586,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__28586,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__28586,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__28586,(3),null);
...
var vec__28592 = result;
var munged_ns = cljs.core.nth.call(null,vec__28592,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__28592,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__28592,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__28592,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__28592,(4),null);
var arity = cljs.core.nth.call(null,vec__28592,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__28596 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__28596,(0),null);
var args = cljs.core.nth.call(null,vec__28596,(1),null);
var vec__28599 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__28599,(0),null);
var name = cljs.core.nth.call(null,vec__28599,(1),null);
...
var G__28602 = (arity + (1));
var G__28603 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28604){
var vec__28605 = p__28604;
var arity = cljs.core.nth.call(null,vec__28605,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__28605,(1),null);
...
return cljs.core.get.call(null,arities,p1__28608_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__28609_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___28616 = arguments.length;
var i__4500__auto___28617 = (0);
while(true){
if((i__4500__auto___28617 < len__4499__auto___28616)){
args__4502__auto__.push((arguments[i__4500__auto___28617]));

var G__28618 = (i__4500__auto___28617 + (1));
i__4500__auto___28617 = G__28618;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28612){
var vec__28613 = p__28612;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__28613,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28610){
var G__28611 = cljs.core.first.call(null,seq28610);
var seq28610__$1 = cljs.core.next.call(null,seq28610);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28611,seq28610__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__28621__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__28621__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__28621__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__28621__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28622 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__28622,(0),null);
var fn_name = cljs.core.nth.call(null,vec__28622,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__28622,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__28622,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__28622,(4),null);
var arity = cljs.core.nth.call(null,vec__28622,(5),null);
...
var o__27686__auto__ = f;
return (o__27686__auto__["getBasis"]).call(o__27686__auto__);
});
/**
...
}catch (e28626){var _e__27693__auto__ = e28626;
...
var G__28627 = (obj[cljs.core.first.call(null,path)]);
var G__28628 = cljs.core.rest.call(null,path);
obj = G__28627;
path = G__28628;
continue;
} else {
...
return (function (accum,p__28629){
var vec__28630 = p__28629;
var bit = cljs.core.nth.call(null,vec__28630,(0),null);
var protocol = cljs.core.nth.call(null,vec__28630,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28633){
var vec__28634 = p__28633;
var ns = cljs.core.nth.call(null,vec__28634,(0),null);
var name = cljs.core.nth.call(null,vec__28634,(1),null);
var selector = cljs.core.nth.call(null,vec__28634,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__28639,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__28639,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__28639,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__28637_SHARP_){
return (obj[cljs.core.first.call(null,p1__28637_SHARP_)]);
});})(name,sorted_matches,vec__28639,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1535633084965
