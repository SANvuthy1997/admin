...
return (new CustomEvent(event_name,(function (){var obj31353 = {"detail":data};
return obj31353;
})()));
} else {
...
var f = (function (){var pred__31360 = cljs.core._EQ_;
var expr__31361 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__31360.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__31361))){
return ((function (pred__31360,expr__31361){
return (function (p1__31354_SHARP_){
return console.warn(p1__31354_SHARP_);
});
;})(pred__31360,expr__31361))
} else {
if(cljs.core.truth_(pred__31360.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__31361))){
return ((function (pred__31360,expr__31361){
return (function (p1__31355_SHARP_){
return console.debug(p1__31355_SHARP_);
});
;})(pred__31360,expr__31361))
} else {
if(cljs.core.truth_(pred__31360.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__31361))){
return ((function (pred__31360,expr__31361){
return (function (p1__31356_SHARP_){
return console.error(p1__31356_SHARP_);
});
;})(pred__31360,expr__31361))
} else {
return ((function (pred__31360,expr__31361){
return (function (p1__31357_SHARP_){
return console.log(p1__31357_SHARP_);
});
;})(pred__31360,expr__31361))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__31364){
...
var eval_fn = cljs.core.get.call(null,map__31365__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__31367_SHARP_);
});})(new_def))
);
...
return (function (p__31368){
var vec__31369 = p__31368;
var ky = cljs.core.nth.call(null,vec__31369,(0),null);
...
}catch (e31374){if((e31374 instanceof Error)){
var e = e31374;
return not_found;
} else {
throw e31374;
...
//# sourceMappingURL=utils.js.map?rel=1535633096727
