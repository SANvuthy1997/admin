...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__30538 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__30538,ch);
...
if(("\\" === ch__$1)){
var ch_30539__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_30539__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_30539__$2);
} else {
}

var G__30540 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__30540;
continue;
}
}
...
var vec__30548 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__30548,(0),null);
var start_column = cljs.core.nth.call(null,vec__30548,(1),null);
...
var G__30551 = cljs.core.conj_BANG_.call(null,a,form);
a = G__30551;
continue;
}
}
...
var _STAR_read_delim_STAR_30552 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_30552;
}});
/**
...
var vec__30559 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__30559,(0),null);
var start_column = cljs.core.nth.call(null,vec__30559,(1),null);
...
var vec__30562 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__30562,(0),null);
var end_column = cljs.core.nth.call(null,vec__30562,(1),null);
...
var vec__30565 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__30565,(0),null);
var start_column = cljs.core.nth.call(null,vec__30565,(1),null);
...
var vec__30568 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__30568,(0),null);
var end_column = cljs.core.nth.call(null,vec__30568,(1),null);
...
var sb = (function (){var G__30571 = (new goog.string.StringBuffer());
G__30571.append(initch);
...
var G__30573 = (function (){var G__30572 = sb;
G__30572.append(ch);
...
switch (G__30577) {
case "\\":
var G__30581 = (function (){var G__30578 = sb;
G__30578.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__30578;
})();
var G__30582 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__30581;
ch = G__30582;
continue;
...
break;
default:
var G__30583 = (function (){var G__30579 = sb;
G__30579.append(ch);

return G__30579;
})();
var G__30584 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__30583;
ch = G__30584;
continue;
...
var vec__30585 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__30585,(0),null);
var end_column = cljs.core.nth.call(null,vec__30585,(1),null);
...
var vec__30588 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__30588,(0),null);
var column = cljs.core.nth.call(null,vec__30588,(1),null);
...
var vec__30593 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__30593,(0),null);
var column = cljs.core.nth.call(null,vec__30593,(1),null);
...
var vec__30598 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__30598,(0),null);
var column = cljs.core.nth.call(null,vec__30598,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__30603 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__30603,(0),null);
var start_column = cljs.core.nth.call(null,vec__30603,(1),null);
...
var vec__30606 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__30606,(0),null);
var end_column = cljs.core.nth.call(null,vec__30606,(1),null);
...
var G__30609 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__30609,true,null,opts,pending_forms);
...
var G__30610 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__30610)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__30610)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__30610)){
...
var _STAR_suppress_read_STAR_30611 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_30611;
}});
...
var G__30612 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__30612,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__30612,rdr,first_line);
...
var G__30616 = matched;
var G__30617 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__30616;
finished = G__30617;
continue;
} else {
...
var _STAR_suppress_read_STAR_30618 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_30618;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env30619 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__30620 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__30620,"(");
...
var G__30621 = (i + (1));
var G__30622 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env30619;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__30623 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__30623);
...
var G__30624 = cljs.core.next.call(null,s__$1);
var G__30625 = ret;
s__$1 = G__30624;
r = G__30625;
continue;
...
var G__30626 = cljs.core.next.call(null,s);
var G__30627 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__30626;
key_vals = G__30627;
continue;
} else {
...
var gensym_env30631 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env30631;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__30632 = token;
var G__30632__$1 = (((G__30632 == null))?null:cljs.core.subs.call(null,G__30632,(1)));
var G__30632__$2 = (((G__30632__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__30632__$1));
var G__30632__$3 = (((G__30632__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__30632__$2));
var G__30632__$4 = (((G__30632__$3 == null))?null:cljs.core.symbol.call(null,G__30632__$3));
if((G__30632__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__30632__$4);
}
})():(function (){var G__30633 = token;
var G__30633__$1 = (((G__30633 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__30633));
if((G__30633__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__30633__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__30644,reader){
...
var opts = map__30645__$1;
var eof = cljs.core.get.call(null,map__30645__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq30651){
var G__30652 = cljs.core.first.call(null,seq30651);
var seq30651__$1 = cljs.core.next.call(null,seq30651);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30652,seq30651__$1);
});


//# sourceMappingURL=reader.js.map?rel=1535633093331
